...
export const districts = [
  // Karnataka
  "Bengaluru", "Mysuru", "Hubballi", "Belagavi", "Mangaluru", "Kalaburagi",
...
export const cases: CaseSummary[] = [
  { id: "C-2041", fir: "FIR/2025/BNG/00412", title: "City Railway Junction Homicide", district: "Bengaluru", status: "Active", severity: "critical", aiConfidence: 87, flagged: true, officer: "Insp. R. Karthik", opened: "2026-04-22", type: "Homicide", victims: 1, suspects: 3, evidence: 24, contradictions: 4 },
  { id: "C-2042", fir: "FIR/2025/MYS/00231", title: "Mysuru Palace Road Bank Heist", district: "Mysuru", status: "Active", severity: "high", aiConfidence: 73, flagged: true, officer: "Insp. P. Anitha", opened: "2026-04-29", type: "Robbery", victims: 0, suspects: 4, evidence: 18, contradictions: 2 },
  { id: "C-2043", fir: "FIR/2025/HBL/00871", title: "Tungabhadra River Body", district: "Hubballi", status: "Review", severity: "high", aiConfidence: 64, flagged: true, officer: "SI K. Mohan", opened: "2026-05-01", type: "Suspicious Death", victims: 1, suspects: 2, evidence: 16, contradictions: 5 },
  { id: "C-2044", fir: "FIR/2025/BLG/00120", title: "Belagavi Highway Hit & Run", district: "Belagavi", status: "Active", severity: "medium", aiConfidence: 58, flagged: false, officer: "Insp. M. Selvi", opened: "2026-05-03", type: "Vehicular", victims: 1, suspects: 1, evidence: 9, contradictions: 1 },
  { id: "C-2045", fir: "FIR/2025/MNG/00094", title: "Mangaluru Market Stabbing", district: "Mangaluru", status: "Active", severity: "high", aiConfidence: 81, flagged: true, officer: "SI A. Ramesh", opened: "2026-05-04", type: "Assault", victims: 1, suspects: 2, evidence: 12, contradictions: 0 },
  { id: "C-2046", fir: "FIR/2025/KLB/00067", title: "Kalaburagi Arson", district: "Kalaburagi", status: "Cold", severity: "medium", aiConfidence: 41, flagged: false, officer: "Insp. D. Vinod", opened: "2026-03-19", type: "Arson", victims: 0, suspects: 0, evidence: 6, contradictions: 0 },
  { id: "C-2047", fir: "FIR/2025/BLL/00203", title: "Ballari Kidnapping", district: "Ballari", status: "Active", severity: "critical", aiConfidence: 76, flagged: true, officer: "Insp. S. Hari", opened: "2026-05-06", type: "Kidnapping", victims: 1, suspects: 2, evidence: 14, contradictions: 3 },
  { id: "C-2048", fir: "FIR/2025/BNG/00418", title: "Ulsoor Lake Drowning", district: "Bengaluru", status: "Review", severity: "low", aiConfidence: 33, flagged: false, officer: "SI L. Priya", opened: "2026-05-07", type: "Drowning", victims: 1, suspects: 0, evidence: 5, contradictions: 1 },
  // Tamil Nadu cases
  { id: "C-2049", fir: "FIR/2025/CHN/00501", title: "Central Station Stabbing", district: "Chennai", status: "Active", severity: "high", aiConfidence: 79, flagged: true, officer: "Insp. V. Kumar", opened: "2026-05-10", type: "Assault", victims: 1, suspects: 2, evidence: 14, contradictions: 2 },
  { id: "C-2050", fir: "FIR/2025/CBE/00142", title: "Coimbatore ATM Robbery", district: "Coimbatore", status: "Review", severity: "medium", aiConfidence: 62, flagged: false, officer: "Insp. B. Sundaram", opened: "2026-05-11", type: "Robbery", victims: 0, suspects: 3, evidence: 9, contradictions: 1 },
  { id: "C-2051", fir: "FIR/2025/MDU/00309", title: "Madurai Temple Road Arson", district: "Madurai", status: "Cold", severity: "medium", aiConfidence: 44, flagged: false, officer: "SI N. Prakash", opened: "2026-04-15", type: "Arson", victims: 0, suspects: 1, evidence: 7, contradictions: 0 },
  { id: "C-2052", fir: "FIR/2025/TRY/00217", title: "Trichy Bus Stand Kidnapping", district: "Trichy", status: "Active", severity: "critical", aiConfidence: 83, flagged: true, officer: "Insp. C. Meena", opened: "2026-05-14", type: "Kidnapping", victims: 1, suspects: 2, evidence: 11, contradictions: 3 },
];
...
export const heatmapZones = [
  ...
  { district: "Hubballi", lat: 15.3647, lng: 75.1240, crimes: 64, risk: 68, officers: 14 },
  { district: "Belagavi", lat: 15.8497, lng: 74.4977, crimes: 41, risk: 52, officers: 9 },
  { district: "Mangaluru", lat: 12.9141, lng: 74.8560, crimes: 53, risk: 60, officers: 11 },
  ...
  { district: "Salem", lat: 11.6643, lng: 78.1460, crimes: 37, risk: 48, officers: 8 },
...
export const caseGraph: { nodes: ForensicNode[]; edges: ForensicEdge[] } = {
  nodes: [
    ...
    // TIMELINE (top)
    {
      id: "cctv-1", zone: "timeline", type: "cctv", label: "CCTV-BNG-0412", sublabel: "20:42 · 6 frames",
    ...
    {
      id: "cctv-2", zone: "timeline", type: "cctv", label: "CCTV-BNG-0418", sublabel: "20:48 · Timestamp ⚠",
  ...
  edges: [
    ...
    },
    {
      ...
      timestamp: "20:48 CCTV-0418", source_ref: "CCTV-BNG-0418",
    ...
    // Victim ↔ Timeline
    {
      ...
      timestamp: "20:42 Apr 22", source_ref: "CCTV-BNG-0412",
    ...
    },
    {
      ...
      timestamp: "20:48 (disputed)", source_ref: "CCTV-BNG-0418",
...
export const contradictions = [
  ...
  { id: "X3", text: "GPS travel from City Station → Shivajinagar in 4m (impossible)", severity: "critical" },
...
export const evidenceVault = [
  { id: "EV-001", name: "CCTV-BNG-0412 footage", type: "video", case: "C-2041", priority: 95, status: "verified", ai: "Altercation visible 20:42" },
  { id: "EV-002", name: "CCTV-BNG-0418 footage", type: "video", case: "C-2041", priority: 88, status: "anomaly", ai: "Timestamp drift detected" },
...
export const crimeScene = { lat: 12.9750, lng: 77.6000, label: "Crime Scene · Altercation 20:42 · C-2041" };

export const movementPath = [
  { lat: 12.9500, lng: 77.5800, t: "18:10", who: "victim" },
  { lat: 12.9716, lng: 77.5946, t: "20:14", who: "victim" },
  { lat: 12.9750, lng: 77.6000, t: "20:42", who: "victim" },

  { lat: 12.9800, lng: 77.6050, t: "20:55", who: "suspect-1" },
  { lat: 12.9750, lng: 77.6000, t: "20:42", who: "suspect-1" },
  { lat: 12.9600, lng: 77.5900, t: "21:25", who: "suspect-1" },

  { lat: 12.9550, lng: 77.5850, t: "19:00", who: "suspect-2" },
  { lat: 12.9650, lng: 77.5900, t: "20:10", who: "suspect-2" },
  { lat: 12.9750, lng: 77.6000, t: "20:42", who: "suspect-2" },
];

export const similarCases = [
  { id: "C-1908", title: "Yeshwanthpur Station Assault", similarity: 78, traits: ["Same MO", "Adjacent location", "Blunt object"] },
  { id: "C-1820", title: "Sadashivanagar Robbery-Homicide", similarity: 71, traits: ["UPI lure pattern", "Night-time CCTV gap"] },
  { id: "C-1755", title: "Shivajinagar Body Discovery", similarity: 64, traits: ["Possible relocation", "Drag marks"] },
];
