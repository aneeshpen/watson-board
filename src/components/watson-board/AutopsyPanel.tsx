...
const HOTSPOTS: Hotspot[] = [
  {
    ...
    fracture: "Depressed occipital fracture (3 sites)",
    laceration: "None",
    observation:
      "Mild diffuse cerebral edema. Subarachnoid hemorrhage in occipital sulci. Primary fatal injury.",
    aiInsight:
      "Cerebral edema pattern consistent with blunt impact 8–10h prior. Single high-energy impact trajectory.",
    causeContribution: "PRIMARY — 70%",
    healthPct: 28,
    toxicology: "Trace diazepam detected",
    fluid: "None",
    layers: ["organs", "skeletal", "nervous", "heatmap"],
  },
  {
    id: "neck",
    name: "Neck / Carotid",
    ...
    weight: "N/A",
    bleeding: "Minor petechial hemorrhage",
    fracture: "C1–C2 no fracture",
    laceration: "Surface abrasion",
    observation:
      "Carotid soft tissue bruising. No fracture. Indicates manual restraint applied briefly.",
    aiInsight:
      "Petechial pattern suggests transient compression — restraint or chokehold prior to blunt assault.",
    causeContribution: "SECONDARY — 10%",
    healthPct: 62,
    toxicology: "None",
    fluid: "None",
    layers: ["organs", "circulatory", "nervous", "heatmap"],
  },
  {
    id: "heart",
    name: "Heart",
    ...
    y: 29.5,
    severity: "low",
    injuryType: "No Direct Injury",
    weight: "320g",
    bleeding: "None",
    fracture: "None",
    laceration: "None",
    observation:
      "Heart 320g within normal limits. Coronary arteries patent. No myocardial infarction.",
    aiInsight:
      "No cardiac contribution to death. Elevated catecholamines consistent with acute traumatic stress.",
    causeContribution: "NONE",
    healthPct: 91,
    toxicology: "None",
    fluid: "None",
  ...
  },
  {
    ...
    injuryType: "Contusion",
    weight: "620g",
    bleeding: "Subpleural hemorrhage",
    fracture: "Rib 4–5 fracture (right)",
    laceration: "None",
    observation:
      "Subpleural hemorrhage inferior lobe. Rib 4–5 fractures consistent with lateral blunt force.",
    aiInsight:
      "Lung contusion pattern suggests right-lateral impact — secondary blow after primary head strike.",
    causeContribution: "SECONDARY — 8%",
    healthPct: 55,
    toxicology: "None",
    fluid: "Mild effusion 80ml",
    layers: ["organs", "circulatory", "skeletal", "heatmap"],
  },
  {
    id: "lung-l",
    name: "Left Lung",
    ...
    y: 27,
    severity: "low",
    injuryType: "Congestion",
    weight: "580g",
    bleeding: "None",
    fracture: "None",
    laceration: "None",
    observation: "Left lung 580g. Mild congestion and basal atelectasis. No primary injury.",
    aiInsight:
      "Congestion secondary to traumatic shock state. Not a direct contributing factor to death.",
    causeContribution: "MINIMAL — 3%",
    healthPct: 72,
    toxicology: "None",
    fluid: "None",
    layers: ["organs", "circulatory", "heatmap"],
  },
  {
    ...
    weight: "1,480g",
    bleeding: "Severe — hemoperitoneum",
    fracture: "None",
    laceration: "Capsular tear 6.5cm",
    observation:
      "Liver 1,480g. Capsular tear right lobe 6.5cm depth 2.1cm. Active hemorrhage at recovery. Hemoperitoneum ~1,200 ml.",
    aiInsight:
      "Liver laceration is secondary cause of death. Blunt abdominal force consistent with weapon impact.",
    causeContribution: "CRITICAL — 20%",
    healthPct: 18,
    toxicology: "None",
    fluid: "1,200 ml hemoperitoneum",
    layers: ["organs", "circulatory", "heatmap"],
  },
  {
    id: "spleen",
    ...
    y: 40,
    severity: "low",
    injuryType: "No Injury",
    weight: "150g",
    bleeding: "None",
    fracture: "None",
    laceration: "None",
    observation: "Spleen 150g, normal size and consistency. No laceration or rupture.",
    aiInsight:
      "No splenic involvement. Absence of splenic injury rules out high-velocity impact at left flank.",
    causeContribution: "NONE",
    healthPct: 95,
    toxicology: "None",
    fluid: "None",
    layers: ["organs", "heatmap"],
  },
  {
    id: "stomach",
    name: "Stomach",
    ...
    y: 43.5,
    severity: "low",
    injuryType: "Contents Analysis",
    weight: "N/A",
    bleeding: "None",
    fracture: "None",
    laceration: "None",
    observation:
      "Partially digested rice and vegetables. Meal approximately 2h before TOD. Pylorus intact.",
    aiInsight:
      "Gastric contents timing corroborates TOD window 19:30–21:00. Last meal ~17:30 confirmed.",
    causeContribution: "NONE",
    healthPct: 88,
    toxicology: "Trace diazepam in gastric wash",
    fluid: "None",
    layers: ["organs", "heatmap"],
  },
  {
    ...
    fracture: "None",
    laceration: "None",
    observation: "Right kidney 130g, normal capsule and cortex. No contusion or laceration.",
    aiInsight:
      "Renal function indicators within normal range. Kidney damage absent — rules out renal blunt trauma.",
    causeContribution: "NONE",
    healthPct: 94,
    toxicology: "None",
    fluid: "None",
  ...
  },
  {
    ...
    fracture: "None",
    laceration: "None",
    observation: "Left kidney 136g. No significant pathology.",
    aiInsight: "No renal pathology. Bilateral kidney integrity rules out fall mechanism.",
    causeContribution: "NONE",
    healthPct: 96,
    toxicology: "None",
    fluid: "None",
  ...
  },
  {
    ...
    y: 53,
    severity: "critical",
    injuryType: "Internal Hemorrhage",
    weight: "N/A",
    bleeding: "~1,200 ml hemoperitoneum",
    fracture: "None",
    laceration: "Mesenteric tear",
    observation:
      "Hemoperitoneum ~1,200 ml. Source: liver laceration + mesenteric tear. Active hemorrhage confirmed.",
    aiInsight:
      "Abdominal hemorrhage volume indicates 30–40 min of active internal bleeding post-injury.",
    causeContribution: "CRITICAL — 20%",
    healthPct: 15,
    toxicology: "None",
    fluid: "1,200 ml blood",
    layers: ["organs", "circulatory", "heatmap"],
  },
  {
    id: "arm-l",
    ...
    y: 42,
    severity: "low",
    injuryType: "Defensive Bruise",
    weight: "N/A",
    bleeding: "Minor soft tissue",
    fracture: "None",
    laceration: "Surface abrasion 3.1cm",
    observation:
      "Defensive contusion 12cm left forearm. Surface abrasion consistent with fall or defensive posture.",
    aiInsight: "Defensive wounds confirm victim was conscious during initial phase of assault.",
    causeContribution: "NONE",
    healthPct: 85,
    toxicology: "None",
    fluid: "None",
    layers: ["organs", "skeletal", "heatmap"],
  },
  {
    id: "arm-r",
    name: "Right Arm",
    ...
    fracture: "None",
    laceration: "None",
    observation: "Right arm unremarkable. No defensive injuries observed.",
    aiInsight:
      "Absence of right-arm defensive wounds suggests attacker approached from victim's right side.",
    causeContribution: "NONE",
    healthPct: 98,
    toxicology: "None",
    fluid: "None",
  ...
  },
  {
    ...
    y: 76,
    severity: "medium",
    injuryType: "Post-mortem Abrasion",
    weight: "N/A",
    bleeding: "None (post-mortem)",
    fracture: "None",
    laceration: "Deep 8.0cm",
    observation:
      "Post-mortem drag mark 8.0cm depth 1.3cm on left thigh. Body relocated after death.",
    aiInsight:
      "Drag pattern orientation consistent with body moved ~4 meters post-mortem. Confirms relocation.",
    causeContribution: "INDICATOR",
    healthPct: 78,
    toxicology: "None",
    fluid: "None",
    layers: ["organs", "skeletal", "heatmap"],
  },
  {
    ...
    fracture: "None",
    laceration: "None",
    observation: "Right leg unremarkable. No trauma identified.",
    aiInsight:
      "No right-leg injuries. Confirms unidirectional assault approach from victim's right.",
    causeContribution: "NONE",
    healthPct: 97,
    toxicology: "None",
    fluid: "None",
...
const LAYERS: { id: Layer; label: string; icon: React.ReactNode; tint?: string }[] = [
  ...
  { id: "heatmap", label: "Trauma Heatmap", icon: <Droplets className="h-3 w-3" /> },
  {
    id: "skeletal",
    label: "Skeletal",
    icon: <Bone className="h-3 w-3" />,
    tint: "rgba(100,160,255,0.18)",
  },
  {
    id: "circulatory",
    label: "Circulatory",
    icon: <Heart className="h-3 w-3" />,
    tint: "rgba(255,60,60,0.18)",
  },
  {
    id: "nervous",
    label: "Nervous System",
    icon: <Cpu className="h-3 w-3" />,
    tint: "rgba(240,200,40,0.15)",
  },
];
      ...
      >
        <div className="flex items-center justify-between mb-5">
          <div>
            <div className="text-[12px] font-black uppercase tracking-[0.18em] text-cyan-400">
              Upload Autopsy Report
            </div>
            <div className="text-[9px] text-slate-500 mt-0.5">
              Any format · data auto-extracted on upload
            </div>
          </div>
        ...
        >
          <motion.div animate={{ y: drag ? -4 : 0 }} transition={{ duration: 0.2 }}>
            <Upload
              className={`h-10 w-10 transition-colors ${drag ? "text-cyan-400" : "text-slate-500"}`}
            />
          </motion.div>
          <div className="text-center">
            <div
              className={`text-[11px] font-semibold transition-colors ${drag ? "text-cyan-300" : "text-slate-400"}`}
            >
        ...
        <div className="mt-4 grid grid-cols-2 gap-1.5">
          {[
            "Organ damage mapping",
            "Injury hotspots",
            "Trauma heatmap",
            "AI forensic insights",
            "Cause of death analysis",
            "Victim profile reveal",
          ].map((f) => (
          ...
          {SIM_STEPS.filter((s) => s.phase !== "complete").map((s, i) => {
            ...
            return (
              <div key={s.phase} className="flex items-center gap-2.5">
                ...
                <span
                  className={`text-[10px] ${done ? "text-emerald-400" : active ? "text-cyan-300" : "text-slate-600"}`}
                >
                  {s.label}
                </span>
              </div>
          ...
          >
            <div>
              ...
              <div className="text-[9px] text-slate-500">
                ...
                {HOTSPOTS.filter((h) => h.severity === "critical").length} critical findings
              </div>
            </div>
            <button
              onClick={onDismiss}
...
function SevBadge({ s }: { s: Sev }) {
  return (
    <span
      className={`rounded px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider ${SEV[s].badge}`}
    >
      {s}
    </span>
  );
    ...
    >
      ...
      <AnimatePresence>
        {hov && !active && (
          ...
          >
            <div
              className="rounded-md border px-2 py-1 text-[9px] font-semibold whitespace-nowrap shadow-xl backdrop-blur-md"
...
function ForensicCard({
  ...
  return (
    ...
    >
      <button onClick={onClose} className="absolute right-2 top-2 text-slate-500 hover:text-white">
        <X className="h-3.5 w-3.5" />
      </button>
      <div className="flex items-center gap-2 mb-2.5 pr-4">
        <div
          className="rounded-md p-1.5 shrink-0"
          style={{ background: c.fill, border: `1px solid ${c.ring}40` }}
        >
      ...
      <div className="space-y-1 text-[9px]">
        ...
        <DetailRow
          label="Bleeding"
          value={hs.bleeding}
          color={hs.severity !== "low" ? c.text : undefined}
        />
        <DetailRow label="Fracture" value={hs.fracture} />
        <DetailRow label="Laceration" value={hs.laceration} />
        {hs.fluid && hs.fluid !== "None" && (
          <DetailRow label="Fluid" value={hs.fluid} color={c.text} />
        )}
        {hs.toxicology && hs.toxicology !== "None" && (
          <DetailRow label="Toxicology" value={hs.toxicology} color="text-fuchsia-400" />
        )}
      </div>
...
function DetailRow({ label, value, color }: { label: string; value: string; color?: string }) {
  return (
    <div className="flex gap-1.5">
      <span className="w-20 shrink-0 text-slate-500 uppercase tracking-wider text-[8px] mt-0.5">
        {label}
      </span>
      ...
      {hotspots.map((hs) => (
        <div
          ...
          style={{
            left: `${hs.x}%`,
            top: `${hs.y}%`,
            width: HEATMAP_SIZE[hs.severity],
            height: HEATMAP_SIZE[hs.severity],
  ...
  return (
    <motion.div
      ...
      style={{
        height: 40,
        background:
          "linear-gradient(to bottom, transparent, rgba(34,211,238,0.35) 50%, transparent)",
      }}
      animate={{ top: ["0%", "100%"] }}
  ...
  return (
    <div className="flex flex-col gap-3 p-3 border-r border-white/5 overflow-y-auto">
      ...
      <div className="rounded-lg border border-cyan-500/25 bg-cyan-950/20 p-2.5">
        <div className="text-[8px] uppercase tracking-widest text-cyan-500/80 mb-1">
          Postmortem Interval
        </div>
        {!dataLoaded ? (
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <div className="text-[9px] text-slate-500 mt-0.5">
              Vitreous potassium + algor mortis
            </div>
          </motion.div>
        )}
      </div>
      ...
      <div className="rounded-lg border border-red-500/25 bg-red-950/15 p-2.5">
        ...
        {!dataLoaded ? (
          ...
          >
            Blunt force trauma — occipital region with depressed skull fracture and subdural
            hemorrhage. Secondary: hepatic hemorrhage.
          </motion.p>
        )}
      </div>
    </div>
    ...
    <div className="flex flex-col gap-3 p-3 border-l border-white/5 overflow-y-auto">
      ...
      {!dataLoaded ? (
        <Placeholder
          ...
          text="Upload a report to populate organ health data"
        />
      ) : (
          ...
          {(["critical", "high", "medium", "low"] as Sev[]).map((s) => (
            <div key={s} className="flex items-center gap-2">
              <div
                ...
                style={{ background: SEV[s].ring, boxShadow: `0 0 6px ${SEV[s].glow}` }}
              />
              <span className="text-[9px] capitalize text-slate-400">
                {s === "critical"
                  ? "Critical — Primary COD"
                  : s === "high"
                    ? "High — Significant"
                    : s === "medium"
                      ? "Medium — Contributing"
          ...
          <ul className="space-y-1.5">
            {[
              ...
              <motion.li
                ...
                className="flex gap-2 text-[9px] text-slate-400 leading-snug"
              >
    ...
    >
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="text-[11px] font-black uppercase tracking-[0.2em] text-cyan-400">
              Forensic Autopsy Visualization
            </span>
            <span className="rounded border border-cyan-500/30 bg-cyan-950/40 px-2 py-0.5 font-mono text-[9px] text-cyan-400">
              CASE C-2041
            </span>
            {dataLoaded && (
              <span className="rounded border border-emerald-500/30 bg-emerald-950/30 px-2 py-0.5 font-mono text-[9px] text-emerald-400 flex items-center gap-1">
                <CheckCircle className="h-2.5 w-2.5" />
                REPORT LOADED
              </span>
            )}
          </div>
          <div className="text-[9px] text-slate-500 mt-0.5 ml-6">
            Report: 26 Apr 2025 · 23:47 &nbsp;|&nbsp; Pathologist: Dr. K. Meenakshi, CFSL Chennai
          </div>
        </div>
        <div className="flex items-center gap-3">
          <button
          ...
          <div className="flex items-center gap-2">
            ...
            <div
              className={`h-1.5 w-1.5 rounded-full ml-1 ${dataLoaded ? "bg-emerald-400 animate-pulse" : "bg-slate-600"}`}
            />
            <span
              className={`text-[9px] font-semibold ${dataLoaded ? "text-emerald-400" : "text-slate-600"}`}
            >
              {dataLoaded ? "AI ACTIVE" : "STANDBY"}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="grid" style={{ gridTemplateColumns: "210px 1fr 210px", minHeight: 580 }}>
        ...
        <div
          ...
          style={{ minHeight: 580 }}
          onClick={(e) => {
            if (e.target === e.currentTarget) setDynSelected(null);
          }}
        >
          <img
            src={anatomyImg}
          ...
          {layerTint && (
            <div
              ...
              style={{ background: layerTint, mixBlendMode: "screen" }}
            />
          )}
          ...
          {[
            ...
            <div
              key={pos}
              className={`absolute ${pos} ${border} border-cyan-500/40 w-5 h-5 pointer-events-none`}
            />
          ))}
          ...
          <AnimatePresence>
            {dataLoaded &&
              HOTSPOTS.filter((h) => h.severity === "critical" && !closedCriticals.has(h.id)).map(
                (h) => (
                  <ForensicCard
                    key={h.id}
                    hs={h}
          ...
          <AnimatePresence>
            {!dataLoaded && !isSimulating && (
              ...
              >
                <div
                  className="flex flex-col items-center gap-3 rounded-2xl border border-cyan-500/20 bg-black/65 px-8 py-6 backdrop-blur-sm text-center"
                  style={{ boxShadow: "0 0 40px rgba(34,211,238,0.06)" }}
                >
                  <div
                    className="flex h-12 w-12 items-center justify-center rounded-xl border border-cyan-500/30 bg-cyan-950/50"
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-[10px] text-slate-500 max-w-[220px] leading-relaxed">
                      Upload any report to reveal organ damage markers, injury cards, and AI
                      forensic analysis
                    </div>
                  </div>
                  <div className="flex flex-wrap justify-center gap-1.5 mt-1">
                    {["Organ markers", "Injury cards", "Heatmap", "AI insights"].map((f) => (
                      <span
                        key={f}
                        className="rounded-full border border-cyan-500/20 bg-cyan-950/30 px-2 py-0.5 text-[8px] text-cyan-500/70 uppercase tracking-wider"
                      >
                        {f}
                      </span>
                    ))}
      ...
      <div className="border-t border-white/5 p-4">
        <div className="flex items-center gap-2 mb-2.5">
          ...
          <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
            Comprehensive Injury & Organ Analysis Table
          </span>
        </div>
            ...
            <thead>
              <tr className="border-b border-white/5">
                {[
                  ...
                  <th
                    key={h}
                    className="pb-1.5 text-left font-semibold uppercase tracking-wider text-slate-500 pr-3 whitespace-nowrap"
                  >
                    {h}
                  </th>
                ))}
                  ...
                  <td colSpan={7} className="py-10 text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="text-[10px] text-slate-600">
                        Upload a report to populate this table
                      </span>
                    </div>
                  </td>
                </tr>
                ...
                HOTSPOTS.map((h, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td
                        className={`py-1.5 pr-3 ${h.bleeding !== "None" && h.bleeding !== "None (post-mortem)" ? c.text : "text-slate-600"}`}
                      >
                        {h.bleeding}
                      </td>
                      <td className="py-1.5 pr-3 text-slate-400">{h.fracture}</td>
                      <td className="py-1.5 pr-3 text-fuchsia-400">
                        {h.toxicology && h.toxicology !== "None"
                          ? h.toxicology
                          : h.fluid && h.fluid !== "None"
                            ? h.fluid
                            : "—"}
                      </td>
                      ...
                      <td className="py-1.5">
                        <div className="flex items-center gap-1.5">
                          <div className="w-12 h-1 rounded-full bg-slate-800 overflow-hidden">
                            <div
                              className="h-full rounded-full"
                              style={{ width: `${h.healthPct}%`, background: c.ring }}
                            />
                          </div>
