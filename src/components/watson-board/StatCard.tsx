...
export function StatCard({
  ...
  return (
    ...
    >
      <div
        className={`pointer-events-none absolute -right-8 -top-8 h-32 w-32 rounded-full bg-gradient-to-br ${toneClass[tone]} blur-2xl opacity-60`}
      />
      <div className="flex items-start justify-between">
        ...
        <div
          className={`grid h-9 w-9 place-items-center rounded-lg border border-primary/35 bg-secondary/50 ${toneClass[tone].split(" ").pop()}`}
        >
